CREATE TABLE EVENT
    (
        ...
        NAME        VARCHAR2(40)
            ...
            CONSTRAINT event_name_ck CHECK (REGEXP_LIKE(NAME, '\s+[A-Za-z0-9]+')),
        DATE_EVENT  DATE
...
CREATE TABLE TRANSPORTATION
    (
        ...
        NAME            VARCHAR2(40)
            ...
            CONSTRAINT transportation_name_ck CHECK (REGEXP_LIKE(NAME, '\s+[A-Za-z0-9]+')),
...
CREATE TABLE MENU
    (
        ...
        NAME            VARCHAR2(40)
            ...
            CONSTRAINT menu_name_ck CHECK (REGEXP_LIKE(NAME, '\s+[A-Za-z0-9]+')),
        DESCRIPTION     VARCHAR2(60),   
        COST            NUMBER(10)
...
CREATE TABLE DRINKS
    (
        ...
        NAME            VARCHAR2(40)
            ...
            CONSTRAINT drinks_name_ck CHECK (REGEXP_LIKE(NAME, '\s+[A-Za-z0-9]+')),
        DESCRIPTION     VARCHAR2(60),   
        COST            NUMBER(10)
