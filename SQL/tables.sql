CREATE TABLE EVENT
    (
        ID_EVENT    NUMBER(3) GENERATED BY DEFAULT ON NULL AS IDENTITY
...
CREATE TABLE TRANSPORTATION
    (
        ID_TRANSPORT    NUMBER(3) GENERATED BY DEFAULT ON NULL AS IDENTITY
...
CREATE TABLE MENU
    (
        ID_MENU         NUMBER(3) GENERATED BY DEFAULT ON NULL AS IDENTITY
...
CREATE TABLE MONEY
    (
        ID_MONEY        NUMBER(3) GENERATED BY DEFAULT ON NULL AS IDENTITY
...
CREATE TABLE DRINKS
    (
        ID_DRINKS       NUMBER(3) GENERATED BY DEFAULT ON NULL AS IDENTITY
...
CREATE TABLE PERSONS 
    (
        ID_PERSON       NUMBER(3) GENERATED BY DEFAULT ON NULL AS IDENTITY
